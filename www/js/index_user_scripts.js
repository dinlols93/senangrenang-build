...
function submit_check_first(){
		...
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/din/dinfrontend/api_registration.php',
			    data: {
...
function submit_to_joomla2(name,username,password1,password2,email1,email2,option,task){
		$.ajax({
			    type: 'POST',
			    url: 'http://user.mydroid.io/din/index.php', //url of joomla website
			    data: {
			    	'option': option,
			    	'task': task,
			    	'jform[name]':name,
...
//     END REGISTER TO JOOMLA
	...
	function submit_to_joomla(){ 
		...
		$.ajax({
                type: "POST",
                url: "http://user.mydroid.io/din/dinfrontend/api_login.php",
                data: {
                    username: jform_username,
     ...
     $( document ).ready(function() {
			    $.ajax({
				    url: 'http://user.mydroid.io/din/api.php?private_key=e4ed5acb3a53e3935a1a8f1676fb111de2a4842a',
				    type: "get",
				    dataType: "json",
				    success: function(response) {
    ...
    {
         /*global activate_page */
         activate_page("#toturialvideomap"); 
         return false;
    });
    ...
    $(document).on("click", ".uib_w_12", function(evt)
    {
         ...
         uib_sb.toggle_sidebar($(".uib_w_21"));  
         return false;
    });
    ...
    $(document).on("click", "#sendfeedback", function(evt)
    {
      ...
      var $form = $( this ),
      url = "http://user.mydroid.io/din/din.php";
